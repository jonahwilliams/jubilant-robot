...
module.exports = exports['default'];
},{"./utils/mapValues":8}],3:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./createStore":5,"./utils/isPlainObject":7,"./utils/mapValues":8,"./utils/pick":9,"_process":13}],4:[function(require,module,exports){
/**
...
},{"./utils/isPlainObject":7}],6:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":1,"./bindActionCreators":2,"./combineReducers":3,"./compose":4,"./createStore":5,"_process":13}],7:[function(require,module,exports){
'use strict';
...
function counterApp() {
  ...
  switch (action.type) {
    case _actions.ADD_TODO:
      var todo = _extends({}, action.payload, { id: state.uid });
      return _extends({}, state, { uid: state.uid + 1, todos: [].concat(state.todos, [todo]) });
    case _actions.COMPLETE_TODO:
      return _extends({}, state, { todos: state.todos.reduce(function (acc, d) {
...
},{"./reducers":11,"redux":6}],13:[function(require,module,exports){
